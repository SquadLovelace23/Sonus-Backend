...
import { createPlaylist, getAllPlaylists, updatePlaylist, deletePlaylist } from '../controllers/playlists.controllers';
...
describe('Playlists Controller', () => {
    ...
    it('should create a playlist', async () => {
        const mockPlaylist = { id: '123', name: 'Test Playlist', userId: '456', cover: 'cover.jpg' };
    ...
    it('should get all playlists', async () => {
        const mockPlaylists = [{ id: '123', name: 'Test Playlist', userId: '456', cover: 'cover.jpg' }];
        (mongoClient.playlist.findMany as jest.Mock).mockResolvedValue(mockPlaylists);
    ...
    it('should update a playlist', async () => {
        const mockPlaylist = { id: '123', name: 'Test Playlist', songId: '789', cover: 'cover.jpg' };
